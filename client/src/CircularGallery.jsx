...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: earing, text: "Earrings" },
      { image: multiRing, text: "Rings" },
      { image: necklace, text: "Pendants" },
      { image: chain, text: "Diamond Chains" },
      { image: ringInHand, text: "Customized Rings"},
      { image: ring, text: "Diamond Jewellery" },
      { image: faceLook, text: "Necklace Set" },
    ];
